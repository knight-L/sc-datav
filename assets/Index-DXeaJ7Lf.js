...
`),ft=Q.forwardRef(({children:e,color:t,segments:n=1,scale:r=1,zoom:i=1,grayscale:a=0,opacity:o=1,radius:s=0,texture:c,toneMapped:l,transparent:u,side:d,...f},p)=>{g({ImageMaterial:dt});let m=Q.useRef(null),h=b(e=>e.size),_=Array.isArray(r)?[r[0],r[1]]:[r,r],v=[c.image.width,c.image.height],y=Math.max(h.width,h.height);return Q.useImperativeHandle(p,()=>m.current,[]),Q.useLayoutEffect(()=>{m.current.geometry.parameters&&m.current.material.scale.set(_[0]*m.current.geometry.parameters.width,_[1]*m.current.geometry.parameters.height)},[_[0],_[1]]),Q.createElement(`mesh`,x({ref:m,scale:Array.isArray(r)?[...r,1]:r},f),Q.createElement(`planeGeometry`,{args:[1,1,n,n]}),Q.createElement(`imageMaterial`,{color:t,map:c,zoom:i,grayscale:a,opacity:o,scale:_,imageBounds:v,resolution:y,radius:s,toneMapped:l,transparent:u,side:d,key:dt.key}),e)}),pt=Q.forwardRef(({url:e,...t},n)=>{let r=w(e);return Q.createElement(ft,x({},t,{texture:r,ref:n}))}),mt=Q.forwardRef(({url:e,...t},n)=>Q.createElement(ft,x({},t,{ref:n}))),ht=Q.forwardRef((e,t)=>{if(e.url)return Q.createElement(pt,x({},e,{ref:t}));if(e.texture)return Q.createElement(mt,x({},e,{ref:t}));throw Error(`<Image /> requires a url or texture`)}),$=t(n()),gt=g(T({u_time:0,u_resolution:new S,u_aspect:0,u_noiseFreq:0,blur:0,speed:0},` varying vec2 vUv;
...
}`));function _t(){let e=b(),t=(0,Q.useRef)(null);return f(e=>{t.current.uniforms.u_time.value=e.clock.getElapsedTime()}),(0,$.jsx)(`group`,{position:[0,-3,-10],children:(0,$.jsxs)(`mesh`,{children:[(0,$.jsx)(`planeGeometry`,{args:[6,6,16,16]}),(0,$.jsx)(gt,{transparent:!0,ref:t,wireframe:!1,u_aspect:e.viewport.aspect,blur:0,speed:.5,u_noiseFreq:1})]})})}var vt=a.div`
  position: relative;
  width: 100vw;
  height: 100vh;
`,yt=g(class extends c{constructor(e,t,n,r,i){super(t,n,r,i);let a=this.parameters.width*.5,o=new m(-a,0),s=new m(0,e),c=new m(a,0),l=new m().subVectors(o,s),u=new m().subVectors(s,c),d=new m().subVectors(o,c),f=l.length()*u.length()*d.length()/(2*Math.abs(l.cross(d))),p=new m(0,e-f),h=(new m().subVectors(o,p).angle()-Math.PI*.5)*2,g=this.attributes.uv,_=this.attributes.position,v=new m;for(let e=0;e<g.count;e++){let t=g.getX(e),n=_.getY(e);v.copy(c).rotateAround(p,h*t),_.setXYZ(e,v.x,n,-v.y)}_.needsUpdate=!0}}),bt=a.div`
  position: absolute;
  bottom: 20px;
  left: 50%;
...
`;function St(){return(0,$.jsxs)(vt,{children:[(0,$.jsxs)(v,{camera:{position:[0,0,100],fov:15},children:[(0,$.jsx)(`fog`,{attach:`fog`,args:[`#6e6e6e`,8.5,12]}),(0,$.jsx)(ut,{pages:4,infinite:!0,children:(0,$.jsx)(Ct,{rotation:[0,0,.15],children:(0,$.jsx)(wt,{})})}),(0,$.jsx)(_t,{})]}),(0,$.jsx)(bt,{children:(0,$.jsxs)(`svg`,{width:`20`,height:`32.5`,viewBox:`0 0 40 65`,children:[(0,$.jsx)(`rect`,{x:`2.5`,y:`2.5`,width:`35`,height:`60`,rx:`17.5`,ry:`17.5`,fill:`none`,stroke:`currentColor`,strokeWidth:`3`}),(0,$.jsx)(xt,{cx:`20`,cy:`15`,r:`3`,fill:`currentColor`})]})})]})}function Ct(e){let t=(0,Q.useRef)(null),n=lt(),r=(0,Q.useRef)(new _(1,1,1));return f((e,i)=>{t.current.rotation.y=-n.offset*(Math.PI*2),e.events.update?.(),r.current.set(-e.pointer.x*2,e.pointer.y+1.5,10),e.camera.position.lerp(r.current,1-Math.exp(-8*i)),e.camera.lookAt(0,0,0)}),(0,$.jsx)(`group`,{ref:t,...e})}function wt({radius:e=1.4,count:t=8}){let n=i();return Array.from({length:t},(r,i)=>(0,$.jsx)(Tt,{url:`/sc-datav/demo_${i%2}.png`,position:[Math.sin(i/t*Math.PI*2)*e,0,Math.cos(i/t*Math.PI*2)*e],rotation:[0,Math.PI+i/t*Math.PI*2,0],onClick:e=>{e.stopPropagation(),n([`/demo0`,`/demo1`][i%2])}},i))}function Tt(e){let t=(0,Q.useRef)(null),n=(0,Q.useRef)(new _(1,1,1)),r=(0,Q.useRef)(.1),i=(0,Q.useRef)(1.5);return f((e,a)=>{t.current.scale.lerp(n.current,1-Math.exp(-10*a)),t.current.material.radius=u.lerp(t.current.material.radius,r.current,1-Math.exp(-8*a)),t.current.material.zoom=u.lerp(t.current.material.zoom,i.current,1-Math.exp(-8*a))}),(0,$.jsx)(ht,{ref:t,transparent:!0,toneMapped:!1,side:2,onPointerOver:e=>{e.stopPropagation(),n.current.setScalar(1.15),r.current=.25,i.current=1,document.body.style.cursor=`pointer`},onPointerOut:()=>{n.current.setScalar(1),r.current=.1,i.current=1.5,document.body.style.cursor=`auto`},...e,children:(0,$.jsx)(yt,{args:[.1,1,1,20,20]})})}export{St as default};